...
class PlatformProcessor(BaseProcessor):
    ...
    def init_table(self):
        ...
        for course_list_info in course_list:
            if '2020-02-16' in str(course_list_info.save_time) or '2019-12-12' in str(course_list_info.save_time):
                continue
